...
#define CONFIG_WIFI_STATIC_RX_BUF_NUM   6
#define CONFIG_WIFI_DYNAMIC_RX_BUF_NUM  6
#define CONFIG_WIFI_STATIC_TX_BUF_NUM   6
#define CONFIG_WIFI_DYNAMIC_TX_BUF_NUM  6
#define CONFIG_WIFI_RX_MGMT_BUF_NUM     4
#define CONFIG_WIFI_CACHE_TX_BUF_NUM    0
#define CONFIG_WIFI_MGMT_SBUF_NUM       6
...
#define CONFIG_WIFI_STA_RM_ENABLED      0
